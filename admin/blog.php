                ...
                <div class="container-fluid">
                    <div class="row">
                     ...
                     <div class=" col-md-6 col-lg-4">
                       ...
                       <div class="imgBox">
                       <img src="./img/post-format.jpg" style="width:100%"/>
                     </div>
                     </a>
                    </div>
                    ...
                    <?php 
                        ...
                        <div class="blog-content">
                            ...
                            <h3><a href="single-blog.php"><?php echo $row['title']; ?></a></h3>
                            ...
                            <div class="action-btn-group float-right d-flex">
                                    <button type="button"
                                        class="custom-action-btn btn btn-primary mr-2 edit-btn"><a href="edit_blog.php?blog_id=<?php echo $row['id']; ?>" style="color:white" >Edit</a></button>
                                    <button type="button"
                                        class="custom-action-btn btn btn-danger delete-btn"><a href="delete_blog.php?blog_id=<?php echo $row['id']; ?>" onclick="return confirmDelete(this);" style="color:white" >Delete</a></button>
                                </div>
                        </div>
                        </div>
                        </div>
