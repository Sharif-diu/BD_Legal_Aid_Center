                    ...
                    <div class="row">
                     ...
                     <div class=" col-md-12 col-lg-12">
                            ...
                            <form method='post' action=''>
                               কেস সমাধান হয়েছে : 
                                <input type="number" name="a" require value="<?php echo $infos[0]; ?>"><br>
                                বিজয়ী কেস (%): 
                                <input type="number" name="b" value="<?php echo $infos[1]; ?>" require><br>
                                ক্লাইন্ট খুশী হয়েছে : 
                                <input type="number" name="c" value="<?php echo $infos[2]; ?>" require><br>
                                বিজয়ী পুরষ্কার: 
                                <input type="number" name="d" value="<?php echo $infos[3]; ?>" require><br>
