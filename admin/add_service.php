...
$message = '';
    if(isset($_POST['submit'])){
        ...
        $query="insert into services (title,icon_url,description) values('$title','$icon_url','$description')"; 
                    ...
                    <div class="row">
                     ...
                     <div class=" col-md-12 col-lg-12">
                            ...
                            <form method='post' action=''>
                                ...
                                Icon url : 
                                <input type="text" name="icon_url" require><br>

                                Short Description: 
                                <textarea  require name='description' rows=10 style='border: 1px solid black;' >       </textarea><br>
