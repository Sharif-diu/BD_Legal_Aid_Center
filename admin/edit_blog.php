...
//print_r($row);
    if(isset($_POST['submit'])){
        ...
        $details_image_url=$_POST['details_image_url'];
        $short_desc = $_POST['short_desc'];
        $time = time();
        $Bdate = BDdate($time);

        $query="update blog set small_image_url='$small_image_url',details_image_url='$details_image_url',title='$title',description='$short_desc',date='$Bdate' where id=$blog_id"; 
                    ...
                    <div class="row">
                     ...
                     <div class=" col-md-12 col-lg-12">
                            ...
                            <form method='post' action=''>
                                ...
                                Small image url : 
                                <input type="text" name="small_image_url" value="<?php echo $row['small_image_url']; ?>" require><br>
                                Details image url : 
                                <input type="text" name="details_image_url" value="<?php echo $row['details_image_url']; ?>" require><br>

                                Short Description: 
                                <textarea id="editor" name='short_desc'  require style='border: 1px solid black;' >  <?php echo $row['description']; ?>     </textarea><br>
