...
$query="SELECT * from services ORDER BY id DESC LIMIT 40 "; 
                ...
                <div class="container-fluid">
                    ...
                    <div class="col-lg-6 col-md-6">
                        <a href="add_service.php">
                            <img src="img/add-camera-1-600400.webp" style="width:100px;margin-left:40%"/>
                        </a>
                    </div>
                        ...
                        if(mysqli_num_rows($result) > 0)
                        {
                            ...
                            <div class="col-lg-6 col-md-6">
                                <div class="single-service mb-60 d-flex flex-nowrap">
                                    ...
                                    <button type="button"
                                        class="custom-action-btn btn btn-primary mr-2 edit-btn"><a href="edit_service.php?service_id=<?php echo $row['id'];?>" style="color:white">Edit</a></button>
                                        <button type="button"
                                        class="custom-action-btn btn btn-danger delete-btn"><a href="delete_service.php?service_id=<?php echo $row['id']; ?>" onclick="return confirmDelete(this);" style="color:white" >Delete</a></button>
                                </div>
                                        <h4><a href="single-service.php"><?php echo $row['title'];?></a></h4>
                                        <p style="max-width: none;"><?php echo $row['description'];?></p>
                                    </div>
                                </div>
                            </div>
                            <!--Single Service End-->
