...
$message = '';
    if(isset($_POST['submit'])){
        ...
        $query="insert into blog (small_image_url,details_image_url,title,description,date) values(
            '$small_image_url','$details_image_url','$title','$short_desc','$Bdate'
        )"; 
                    ...
                    <div class="row">
                     ...
                     <div class=" col-md-12 col-lg-12">
                            ...
                            <form method='post' action=''>
                                ...
                                Small image url : 
                                <input type="text" name="small_image_url" require><br>
                                Details image url : 
                                <input type="text" name="details_image_url" require><br>

                                Short Description: 
                                <textarea id="editor" require name='short_desc' style='border: 1px solid black;' >       </textarea><br>
