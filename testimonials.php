...
<head>
	...
	<title>স্বীকৃতিপত্র || BDLAC</title>
...
<body>
	...
	<div class="wrapper">
		    ...
		    <div class="container">
		        <div class="row">
		            <div class="page-banner-content col-12 text-center">
                        <h2>স্বীকৃতিপত্র</h2>
                        <p>আইন সম্পর্কে জানুন এবং মানুন। নিজেই অপকর্ম থেকে দুরে থাকুন এবং দুষ্কার্যের প্রতিবাদ করুন।</p>
		...
		<div class="all-testimonial-area pt-120 pb-70">
		    <div class="container">
		        <div class="row">
		            <div class="col-12">
		                <!--Section Title Start-->
