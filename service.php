...
<head>
	...
	<title>অনুশীলনের ক্ষেত্র || BDLAC</title>
...
<body>
	...
	<div class="wrapper">
		                        ...
		                        <div class="header-menu-area text-right">
		                            <nav>
		                                <ul class="main-menu">
		                                    ...
		                                    <li class="active"><a href="service.php">অনুশীলনের ক্ষেত্র</a></li>
		    ...
		    <div class="container">
		        <div class="row">
		            <div class="page-banner-content col-12 text-center">
                        <h2>সার্ভিস সমূহ</h2>
                        <p>"আইন হলো একধরণের বিধান, যাহা অন্যায়ের বিরুদ্ধে শাস্তির ব্যবস্থা করে এবং ন্যায়কে প্রতিষ্ঠা করার সর্বাত্মক প্রচেষ্টা চালায়"।</p>
		...
		<div class="service-page-banner pt-120 pb-60">
		    <div class="container">
		        <div class="row">
		            <div class="col-lg-8 ml-auto mr-auto col-12">
		                <div class="service-banner-img img-full">
		                    <img src="img/service/sevices8.png" alt="">
		                </div>
		            </div>
		        </div>
		        <div class="row">
		            <div class="col-12">
                        ...
                        <div class="section-title text-center mb-70">
                            <h2>সেরা পরিষেবা প্রদান  <br> <span>কারণ!!</span> আমাদের সেরা আইনজীবী আছে</h2>           
                            <p>বিভিন্ন এখতিয়ার মোকাবিলার জন্য আমাদের কাছে  বিভাগ রয়েছে।</p>
                        </div>
                        <!--Section Title End-->
		            </div>
		        </div>
				    ...
				    <?php 
		                ...
		                <div class="single-service mb-50">
		                    <div class="single-service-img img-full">
		                        <a href="single-service.php"><img src="img/service/single-service/single-service2.jpg" alt=""></a>
		                    </div>
