...
$query3="SELECT * from discuss ORDER BY RAND() "; 
...
<body>
	...
	<div class="wrapper">
		                        ...
		                        <div class="header-menu-area text-right">
		                            <nav>
		                                <ul class="main-menu">
		                                    ...
		                                    <li class="active"><a href="#">পেইজ সমূহ</a>
		                                        <!--Dropdown Menu Start-->
		                                        <ul>
		...
		<div class="history-page-banner pt-120 pb-10">
		    <div class="container">
		        <div class="row">
		        ...
		        <div class="row">
		            <div class="col-12">
                        ...
                        <div class="section-title text-center mb-70">
                            <h2>আলোচনা <br> আপনি আমাদের সম্পর্কে জানতে পারেন</h2>           
		        ...
		        <div class="row">
                    <div class="col-lg-10 offset-lg-1 col-md-12 offset-0">
                        <div class="calltoaction text-center">
                            <h3>আরও তথ্যের জন্য উকিলদের সিভি ডাউনলোড করুন</h3>
                            <p>Your text is here</p>
                            <a href="#" class="cta-button"><i class="icofont icofont-file-pdf"></i> পিডিএফ সিভি ডাউনলোড করুন </a>
                        </div>
                    </div>
		        </div>
		    </div>
