		                        ...
		                        <div class="header-menu-area text-right">
		                            <nav>
		                                <ul class="main-menu">
		                                    ...
		                                    <li class="active"><a href="contact.php">যোগাযোগ করুন</a></li>
		                                </ul>
		                            </nav>
		                        </div>
		                    </div>
		...
		<div class="contact-us-area pt-120">
		    <div class="container">
		        <div class="row">
                    ...
                    <div class="col-md-5 contact-address" style="    margin-bottom: 10px;">
                        <div class="contact-information">
                            <ul>
                                ...
                                <li>
                                    <h5>ফোন করুন</h5>
                                    <p><a href="tel:+8801265897568">+880 1683 381821</a><br>
                                       <a href="tel:+8801265897568">+880 1683 381821</a>
                                    </p>
                                </li>
                                <li>
                                    <h5>ওয়েব</h5>
                                    <p><a href="#">info@bdlac.com</a>
		                        ...
		                        <div class="row">
		                            <div class="col-md-6">
		                                <div class="single-input">
		                                    <input name="name" placeholder="নাম" type="text">
		                                </div>
		                            </div>
		                            <div class="col-md-6">
		                                <div class="single-input">
		                            ...
		                            <div class="col-md-12">
		                                <div class="single-input">
		                                    <textarea name="message" cols="10" rows="4" placeholder="আপনার তথ্য লিখুন"></textarea>
		                                </div>
		                            </div>
		                            <div class="col-md-12">
		                                <div class="single-input">
		                                    <button class="sent-btn" type="submit">জমা দিন</button>
		                                </div>
		                            </div>
		                        </div>
		                    </form>
